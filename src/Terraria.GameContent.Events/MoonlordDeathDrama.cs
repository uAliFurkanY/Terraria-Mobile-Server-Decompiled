...
namespace Terraria.GameContent.Events
{
	public class MoonlordDeathDrama
	{
		...
		public static void ThrowPieces(Vector2 MoonlordCoreCenter, int DramaSeed)
		{
			...
			_pieces.Add(new MoonlordPiece(TextureManager.Load("Images/Misc/MoonExplosion/Spine"), new Vector2(64f, 150f), MoonlordCoreCenter + new Vector2(0f, 50f), value * 6f, 0f, r.NextFloat() * 0.1f - 0.05f));
			value = Vector2.UnitY.RotatedBy(r.NextFloat() * ((float)Math.PI / 2f) - (float)Math.PI / 4f + (float)Math.PI);
			_pieces.Add(new MoonlordPiece(TextureManager.Load("Images/Misc/MoonExplosion/Shoulder"), new Vector2(40f, 120f), MoonlordCoreCenter + new Vector2(50f, -120f), value * 10f, 0f, r.NextFloat() * 0.1f - 0.05f));
			value = Vector2.UnitY.RotatedBy(r.NextFloat() * ((float)Math.PI / 2f) - (float)Math.PI / 4f + (float)Math.PI);
			_pieces.Add(new MoonlordPiece(TextureManager.Load("Images/Misc/MoonExplosion/Torso"), new Vector2(192f, 252f), MoonlordCoreCenter, value * 8f, 0f, r.NextFloat() * 0.1f - 0.05f));
			value = Vector2.UnitY.RotatedBy(r.NextFloat() * ((float)Math.PI / 2f) - (float)Math.PI / 4f + (float)Math.PI);
			_pieces.Add(new MoonlordPiece(TextureManager.Load("Images/Misc/MoonExplosion/Head"), new Vector2(138f, 185f), MoonlordCoreCenter - new Vector2(0f, 200f), value * 12f, 0f, r.NextFloat() * 0.1f - 0.05f));
		}
