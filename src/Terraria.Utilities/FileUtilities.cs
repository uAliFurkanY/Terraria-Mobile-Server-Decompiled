...
namespace Terraria.Utilities
{
	public static class FileUtilities
	{
		...
		public static bool MoveToCloud(string localPath, string cloudPath)
		{
			...
			WriteAllBytes(cloudPath, ReadAllBytes(localPath, false), true);
			Delete(localPath, false);
			return true;
		}
		...
		public static bool MoveToLocal(string cloudPath, string localPath)
		{
			...
			WriteAllBytes(localPath, ReadAllBytes(cloudPath, true), false);
			Delete(cloudPath, true);
			return true;
		}
