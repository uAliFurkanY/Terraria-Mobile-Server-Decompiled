...
namespace Terraria.Localization
{
	public class NetworkText
	{
		...
		{
			NetworkText networkText = new NetworkText(text, Mode.Formattable);
			networkText._substitutions = ConvertSubstitutionsToNetworkText(substitutions);
			return networkText;
		}
		...
		{
			NetworkText networkText = new NetworkText(key, Mode.LocalizationKey);
			networkText._substitutions = ConvertSubstitutionsToNetworkText(substitutions);
			return networkText;
		}
		...
		public override string ToString()
		{
			...
			catch (Exception arg)
			{
				...
				str += ToDebugInfoString();
				str += "\n";
				str = str + "Exception: " + arg;
				SetToEmptyLiteral();
			}
			return _text;
		}
