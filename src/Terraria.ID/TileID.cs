	...
	public class TileID
	{
		public static class Sets
		{
			...
			public static class RoomNeeds
			{
				...
				public static int[] CountsAsTable = new int[8]
				{
					14,
					18,
					87,
				...
				public static int[] CountsAsDoor = new int[7]
				{
					10,
					11,
					19,
			...
			public static bool[] GeneralPlacementTiles = Factory.CreateBoolSet(true, 225, 41, 43, 44, 226, 203, 112, 25, 70, 151, 21, 31);
